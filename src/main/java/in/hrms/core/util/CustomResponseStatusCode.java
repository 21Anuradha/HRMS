...
public class CustomResponseStatusCode {
    ...
    private CustomResponseStatusCode() {
        ...
        throw new IllegalStateException("CustomResponseStatusCode Class");
    ...
    public static final int EXCEPTION_OCCURE = 2009;

    public static final int UNAUTHORIZED_IP = 2010;

    public static final int DEFAULT_RESPONSE = 2011;

    public static final int INVALID_PUBLIC_KEY = 2012;
    ...
    public static final int REQUEST_PARAMETER_INVALID = 2027;

    public static final int EXCEPTION_WITH_ACCESS_TOKEN = 5000;
    ...
    public static final int GIFT_CARD_MAX_NO_OF_LIMIT = 5005;

    public static final int INSUFFICIENT_WALLET_BALANCE_OF_PARENT_USER = 5006;

    public static final int ONLY_RETAILER_CAN_PROCESS_THIS_REQUEST = 5007;

    public static final int PLEASE_SET_COMM_RULE_FIRST = 5008;
    ...
    public static final int INVALID_REQUEST = 3001;

    public static final int NOT_ELIGIBLE = 3002;

    public static final int ELIGIBLE = 3003;

    public static final int INVALID_REQUEST_AMOUNT = 3004;

    public static final int CUSTOMER_ALREADY_EXIST = 3005;

    public static final int RECEIPANT_ALREADY_EXIST = 3006;
    ...
    public static final int CREDENTIAL_ALREADY_EXISTS = 1172;
